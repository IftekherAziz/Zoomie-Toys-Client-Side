    ...
    <>
      <section className="flex items-center h-screen p-16 bg-white">
        <div className="container flex flex-col items-center justify-center px-5 mx-auto my-8">
          ...
          <img className="" src="https://i.ibb.co/GnNLnTv/404.gif" alt="" />
          <div className="max-w-md text-center">
            <h2 className="mb-8 font-extrabold text-9xl text_color">
            ...
            <Link to="/">
              <button className="btn mb-10">Back to homepage</button>
            </Link>
          </div>
        </div>
      </section>
