  ...
  return (
    <div className="mb-20">
      ...
      <div className="gap-8 sm:flex m-6">
        <div className="w-full px-4 py-4 mt-6 bg-white rounded-lg shadow-lg sm:w-1/2 md:w-1/2 lg:w-1/">
          <img
            data-aos="fade-up"
            src="https://stytch.com/blog/wp-content/uploads/2022/01/How-a-refresh-token-is-generated-and-used-1.png"
            alt="Blog-Image"
          />
          <h4 className="py-4 text-xl font-semibold text-gray-700 sm:text-xl ">
            What is an access token and refresh token? How do they work and
            where should we store them on the client-side?
          </h4>
          <p className="py-4 text-gray-500 text-md  text-justify">
          ...
          <p className="py-4 text-gray-500 text-md xt-justify">
        ...
        <div className="w-full px-4 py-4 mt-6 bg-white rounded-lg shadow-lg sm:w-1/2 md:w-1/2 lg:w-1/2">
          <img
            data-aos="fade-up"
